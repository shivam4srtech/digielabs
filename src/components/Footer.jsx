            ...
            <ul className="space-y-4 text-sm text-slate-400">
              <li className="flex items-start gap-3">
                ...
                <Link 
                    ...
                    href="mailto:hello@digielabs.com" 
              ...
              <li className="flex items-start gap-3">
                ...
                <Link href="tel:+1234567890" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">+91 80507 39493</Link>
              </li>
              <li className="flex items-start gap-3">
                <svg className="w-5 h-5 text-blue-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                ...
                <Link href={'https://maps.app.goo.gl/NCMmQyjm8MPB5xmX7'} target="_blank" rel="noopener noreferrer" className='hover:text-white transition-colors'>
